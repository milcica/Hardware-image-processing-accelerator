# 0 "/home/kowalski/Desktop/ETF/CETVRTA-GODINA/DVS/dvs25_projekat_g6/software-new/platform/hw/sdt/system-top.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/kowalski/Desktop/ETF/CETVRTA-GODINA/DVS/dvs25_projekat_g6/software-new/platform/hw/sdt/system-top.dts"
/dts-v1/;
# 1 "/home/kowalski/Desktop/ETF/CETVRTA-GODINA/DVS/dvs25_projekat_g6/software-new/platform/hw/sdt/zynq-7000.dtsi" 1
# 10 "/home/kowalski/Desktop/ETF/CETVRTA-GODINA/DVS/dvs25_projekat_g6/software-new/platform/hw/sdt/zynq-7000.dtsi"
/ {
 #address-cells = <1>;
 #size-cells = <1>;
...
# 3 "/home/kowalski/Desktop/ETF/CETVRTA-GODINA/DVS/dvs25_projekat_g6/software-new/platform/hw/sdt/system-top.dts" 2
# 1 "/home/kowalski/Desktop/ETF/CETVRTA-GODINA/DVS/dvs25_projekat_g6/software-new/platform/hw/sdt/pl.dtsi" 1
/ {
 amba_pl: amba_pl {
  ranges;
  compatible = "simple-bus";
  ...
  acc_image_filter_0: acc_image_filter@40000000 {
   xlnx,max-filter-radius = <4>;
   compatible = "xlnx,acc-image-filter-1.0";
   status = "okay";
   clock-names = "clk";
   xlnx,ip-name = "acc_image_filter";
   xlnx,edk-iptype = "PERIPHERAL";
   reg = <0x40000000 0x1000>;
   clocks = <&clkc 15>;
   xlnx,max-img-width = <512>;
   xlnx,name = "acc_image_filter_0";
  };
  axi_dma_0: dma@40400000 {
   ...
   xlnx,s-axis-s2mm-tdata-width = <16>;
   xlnx,micro-dma = <0>;
...
# 4 "/home/kowalski/Desktop/ETF/CETVRTA-GODINA/DVS/dvs25_projekat_g6/software-new/platform/hw/sdt/system-top.dts" 2
# 1 "/home/kowalski/Desktop/ETF/CETVRTA-GODINA/DVS/dvs25_projekat_g6/software-new/platform/hw/sdt/pcw.dtsi" 1
 &ps7_cortexa9_0 {
 ...
 &amba {
  processing_system7_0: processing_system7@0 {
   ...
   xlnx,pcw-package-ddr-dqs-to-clk-delay-0 = <0xffffffff 0xffff38c8>;
   xlnx,pcw-uiparam-ddr-dqs-3-length-mm = <0>;
   xlnx,pcw-package-ddr-dqs-to-clk-delay-1 = <0xffffffff 0xffffe890>;
   xlnx,pcw-qspi-grp-single-ss-enable = <1>;
   xlnx,pcw-act-usb0-peripheral-freqmhz = <60>;
   xlnx,pcw-mio-27-pullup = "enabled";
   xlnx,pcw-package-ddr-dqs-to-clk-delay-2 = <0xffffffff 0xffffdcd8>;
   xlnx,pcw-mio-38-direction = "inout";
   xlnx,pcw-package-ddr-dqs-to-clk-delay-3 = <0xffffffff 0xffff7f18>;
   xlnx,pcw-en-spi0 = <0>;
   xlnx,pcw-en-spi1 = <0>;
   ...
   xlnx,pcw-uiparam-act-ddr-freq-mhz = <525>;
   ...
   xlnx,pcw-ddr-ddr-pll-freqmhz = <1050>;
   xlnx,pcw-enet0-reset-enable = <1>;
   ...
   xlnx,pcw-act-ttc0-clk0-peripheral-freqmhz = <0x6750918>;
   ...
   xlnx,pcw-package-ddr-board-delay0 = <0x441d8>;
   xlnx,pcw-wdt-peripheral-divisor0 = <1>;
   xlnx,s-axi-hp1-data-width = <64>;
   xlnx,pcw-package-ddr-board-delay1 = <0x3f7a0>;
   ...
   xlnx,pcw-uiparam-ddr-dqs-1-length-mm = <0x1dada80>;
   ...
   xlnx,pcw-act-ttc1-clk2-peripheral-freqmhz = <0x6750918>;
   ...
   xlnx,pcw-act-apu-peripheral-freqmhz = <650>;
   ...
   xlnx,pcw-uiparam-ddr-dqs-0-length-mm = <0x1ea6ae0>;
   ...
   xlnx,pcw-uiparam-ddr-dq-1-length-mm = <0x1da3e40>;
   ...
   xlnx,pcw-mio-tree-signals = "gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#reset#gpio[10]#gpio[11]#gpio[12]#gpio[13]#rx#tx#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#gpio[48]#gpio[49]#gpio[50]#gpio[51]#mdc#mdio";
   ...
   xlnx,pcw-apu-peripheral-freqmhz = <650>;
   ...
   xlnx,pcw-uiparam-ddr-clock-1-length-mm = <0x1aa7bb0>;
   ...
   xlnx,pcw-uiparam-ddr-dqs-to-clk-delay-0 = <0xffffffff 0xffff38c8>;
   xlnx,pcw-uiparam-ddr-dqs-to-clk-delay-1 = <0xffffffff 0xffffe890>;
   xlnx,pcw-uiparam-ddr-dqs-to-clk-delay-2 = <0xffffffff 0xffffdcd8>;
   xlnx,pcw-uiparam-ddr-dqs-to-clk-delay-3 = <0xffffffff 0xffff7f18>;
   ...
   xlnx,pcw-uiparam-ddr-dq-0-length-mm = <0x1eb5540>;
   ...
   xlnx,pcw-act-ttc0-clk1-peripheral-freqmhz = <0x6750918>;
   ...
   xlnx,pcw-uiparam-ddr-clock-0-length-mm = <0x1aa7bb0>;
   xlnx,pcw-mio-36-iotype = "LVCMOS , 1.8V";
   xlnx,pcw-act-can1-peripheral-freqmhz = <0x16b4ddc>;
   xlnx,pcw-cpu-cpu-pll-freqmhz = <1300>;
   ...
   xlnx,pcw-uiparam-ddr-board-delay0 = <0x441d8>;
   xlnx,pcw-uiparam-ddr-board-delay1 = <0x3f7a0>;
   xlnx,pcw-uiparam-ddr-board-delay2 = <0x14c08>;
   xlnx,pcw-mio-53-iotype = "LVCMOS , 1.8V";
   xlnx,pcw-uiparam-ddr-board-delay3 = <0x16760>;
   ...
   xlnx,pcw-act-ttc1-clk0-peripheral-freqmhz = <0x6750918>;
   ...
   xlnx,pcw-uiparam-ddr-freq-mhz = <525>;
   xlnx,pcw-gp0-en-modifiable-txn = <1>;
   xlnx,pcw-nor-sram-cs1-we-time = <0>;
   xlnx,pcw-act-ttc0-clk2-peripheral-freqmhz = <0x6750918>;
   ...
   xlnx,pcw-en-i2c0 = <0>;
   xlnx,pcw-dci-peripheral-divisor0 = <52>;
   xlnx,pcw-en-i2c1 = <0>;
   xlnx,pcw-dci-peripheral-divisor1 = <2>;
   xlnx,pcw-mio-5-slew = "slow";
   xlnx,pcw-core0-fiq-intr = <0>;
   xlnx,s-axi-hp1-id-width = <6>;
   xlnx,pcw-fclk1-peripheral-clksrc = "IO , PLL";
   xlnx,pcw-act-ttc1-clk1-peripheral-freqmhz = <0x6750918>;
...
# 5 "/home/kowalski/Desktop/ETF/CETVRTA-GODINA/DVS/dvs25_projekat_g6/software-new/platform/hw/sdt/system-top.dts" 2
/ {
 board = "pynq-z2";
 ...
 cpus_a9: cpus-a9@0 {
  ...
  address-map = <0xf0000000 &amba 0xf0000000 0x10000000>,
         ...
         <0x40000000 &acc_image_filter_0 0x40000000 0x1000>,
