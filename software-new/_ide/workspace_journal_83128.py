# 2026-05-28T09:04:03.120292
import vitis

client = vitis.create_client()
client.set_workspace(path="software-new")
...
comp = client.create_app_component(name="img_filter_app",platform = "$COMPONENT_LOCATION/../platform/export/platform/platform.xpfm",domain = "standalone_ps7_cortexa9_0")

comp = client.get_component(name="img_filter_app")
comp.build()
