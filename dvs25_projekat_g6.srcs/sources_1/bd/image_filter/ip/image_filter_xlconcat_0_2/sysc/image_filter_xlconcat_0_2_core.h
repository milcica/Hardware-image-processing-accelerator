...
#ifndef _image_filter_xlconcat_0_2_core_h_
#define _image_filter_xlconcat_0_2_core_h_
...
class image_filter_xlconcat_0_2_core : public sc_module 
{
    public: 
       image_filter_xlconcat_0_2_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , In2    ( "In2" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(image_filter_xlconcat_0_2_core);
    ...
    virtual ~image_filter_xlconcat_0_2_core() = default;
